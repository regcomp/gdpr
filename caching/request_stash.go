...
func CreateRequestStash(cache IServiceCache) *RequestStash {
	return &RequestStash{cache: cache}
}

func (rs *RequestStash) StashRequest(r *http.Request) (string, error) {
...
func (rs *RequestStash) RetrieveRequest(id string) (*CachedRequest, error) {
